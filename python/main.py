    ...
    for campaign in campaign_list:
        ...
        for mode in MODE_LIST:
            ...
            for leafSize in [0]:
                ...
                info.fname_trainlog = IFROOT + campaign + '/train.log.txt'
                info.fname_testlog = IFROOT + campaign + '/test.log.txt'
                info.fname_nodeData = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/nodeData_' + campaign + suffix + '.txt'
                info.fname_nodeInfo = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/nodeInfos_' + campaign + suffix + '.txt'

                info.fname_trainbid = IFROOT + campaign + '/train_bid.txt'
                info.fname_testbid = IFROOT + campaign + '/test_bid.txt'
                info.fname_baseline = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/baseline_' + campaign + suffix + '.txt'

                info.fname_monitor = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/monitor_' + campaign + suffix + '.txt'
                info.fname_testKmeans = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/testKmeans_' + campaign + suffix + '.txt'
                info.fname_testSurvival = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/testSurvival_' + campaign + suffix + '.txt'

                info.fname_evaluation = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/evaluation_' + campaign + suffix + '.txt'
                info.fname_baseline_q = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/baseline_q_' + campaign + suffix + '.txt'
                info.fname_tree_q = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/tree_q_' + campaign + suffix + '.txt'
                info.fname_baseline_w = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/baseline_w_' + campaign + suffix + '.txt'
                info.fname_tree_w = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/tree_w_' + campaign + suffix + '.txt'

                info.fname_pruneNode = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/pruneNode_' + campaign + suffix + '.txt'
                info.fname_pruneEval = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/pruneEval_' + campaign + suffix + '.txt'
                info.fname_testwin = OFROOT + campaign + '/' + modeName + '/paraTune/leafSize_' + str(
                    leafSize) + '/testwin_' + campaign + suffix + '.txt'
                # baseline
